...
const COMPRESSION_CONFIG = {
    ...
    maxHeight: 1920,
    quality: 0.8,
    maxSizeMB: 10 // Target max size after compression
};
...
async function compressImage(file, config = COMPRESSION_CONFIG) {
...
async function handleFileSelect(e) {
    ...
    if (selectedFile) {
        ...
        if (fileType === 'image') {
            try {
                document.getElementById('fileInfo').innerHTML = infoHTML + '<p style="color: #ffff00;">[COMPRESSING...]</p>';
...
async function handleUpload(e) {
    ...
    try {
        ...
        // Upload using Supabase's native method with better progress tracking
